...
def init_global_features_OLD(list_path_features, args) :
  global_features = {}
  authors_features = {}
  for path in list_path_features :
    ...
    for url in d['url'].keys() :
      ...
      if(args.learnType == 'block') :
        ...
        authors_features[path][url] = d['url'][url]['global']
  return global_features, authors_features
...
#  print len(test_specific_features2)

#  global_features, authors_features, authors_test = init_features(args.list_path, set_test, args)


#  test_specific_features2 = init_test_features_bak(authors_features2, set_test, args)

#  for path, other in authors_features2.iteritems() :
#    for url, features in other.iteritems() :
#      print len(features), len(authors_features[path][url])

#  for feat, cpt in test_specific_features.iteritems() :
#    print feat, cpt
#  print test_specific_features.keys()

#  exit(0)

  
#  diff = diff_features(global_features2, test_specific_features)
#  diff2 = diff_features(global_features2, test_specific_features2)

#  print len(global_features.keys())
#  print len(global_features2.keys())
#  print len(test_specific_features.keys())
#  print len(diff.keys())
#  print len(diff2.keys())
...
#  base_vector = filter_freq(global_features, args.ngramMinFreq, args.ngramMaxFreq)
#  base_vector2 = filter_freq(global_features2, args.ngramMinFreq, args.ngramMaxFreq)
#  base_vector3 = filter_freq(test_specific_features, args.ngramMinFreq, args.ngramMaxFreq)
#  base_vector4 = filter_freq(diff, args.ngramMinFreq, args.ngramMaxFreq)

#  print len(base_vector)
#  print len(base_vector2)
#  print len(base_vector3)
#  print len(base_vector4)
#  print base_vector[:100]
#  print base_vector4[:100]

#  exit(0)

#
  global_features, authors_features, authors_test = init_features(args.list_path, set_test, args)
#  test_features_extracted = extract_features_bak(global_features)
  base_vector = filter_freq(global_features, args.ngramMinFreq, args.ngramMaxFreq)
#  print len(test_features_extracted)
#  print len(base_vector)
  fitness_chromosome = fitness(chromosome, base_vector, authors_features, authors_test)
  print fitness_chromosome
#
